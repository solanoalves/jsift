...
public class SiftTest {
	...
	public void comparar() {
		try {
			...
			BufferedImage base = ImageIO.read(new File("knn.png"));
...
//			System.out.println("-----");
//			BufferedImage target = ImageIO.read(new File("cnh.png"));
//			Image imgTarget = TransformImage.binarizeSkeletonizeImage(new Image(target));
...
//			//Pontos
			...
			for(ScaleSpacePoint point : pointsBase) {
				go1.drawOval((int)point.getX()-3, (int)point.getY()-7, 6, 6);
			}
			File outputfileo1 = new File("transform.png");
			ImageIO.write(bio1, "png", outputfileo1);

//			BufferedImage bio2 = imgTarget.toBufferedImage();
//			Graphics go2 = bio2.getGraphics();
//			go2.setColor(new Color(120, 120, 120));
//			for(ScaleSpacePoint point : pointsTarget) {
//				go2.drawOval((int)point.getX()-3, (int)point.getY()-7, 6, 6);
//			}
//			File outputfileo2 = new File("linearized2.png");
