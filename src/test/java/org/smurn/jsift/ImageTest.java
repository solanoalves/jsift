...
public class ImageTest {
	...
	public void comparar() {
		try {
			...
			Image imgBase = BinarizeImage.binarizeImage(new Image(base));
			...
			System.out.println("-----");
			BufferedImage target = ImageIO.read(new File("asspb.png"));
			Image imgTarget = BinarizeImage.binarizeImage(new Image(target));
...
//			go1.setColor(new Color(120, 120, 120));
