 ...
 * then be set to the latter value. The end result will be a erosion of bright
 * structures in the image.
 * 
 * https://www.programcreek.com/java-api-examples/index.php?source_dir=thehand-master/src/main/java/com/seniorproject/thehand/morohology/Erosion.java
 */
public class Erosion {
	...
	public BufferedImage erosion(BufferedImage img) {
		...
		for (int x = 0; x < shapeSize; x++) {
			for (int y = 0; y <= filterHeight; y++) {
				window = (byte[]) oldData.getDataElements(0, y, sSize, sSize, null);
				newValue = min(window);
